    ...
    class PSInvoke
    {
        ...
        public static void PowerNETDOM(string InputStreams)
        {
            using (PowerShell PowerShellInstance = PowerShell.Create())
            {
                ...
                PowerShellInstance.AddParameter("InputStream", InputStreams);
        ...
        public static string PowerEDM(string InputStreams)
        {
            ...
            using (PowerShell PowerShellInstance = PowerShell.Create())
            {
                ...
                PowerShellInstance.AddParameter("Data", "passwordAdministratorPassword2017");
                ...
                IAsyncResult results = PowerShellInstance.BeginInvoke<PSObject>(outputCollection);
